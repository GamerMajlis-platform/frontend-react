    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          placeholder={t("profile.search.placeholder") || "Search profiles..."}
          className="w-full px-4 py-3 pr-12 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-primary/50 focus:bg-slate-700/80 transition-all"
        />
      ...
      {showResults && searchResults.length > 0 && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-slate-800/95 backdrop-blur-xl border border-slate-600/50 rounded-xl shadow-xl z-50 max-h-96 overflow-y-auto">
          <div className="p-2">
      ...
      {/* Suggestions (shown when input is empty or no search results) */}
